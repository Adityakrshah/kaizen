...
export default function MockTestResult() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      {/* 3. TABS NAVIGATION */}
      <Tabs defaultValue="overview" className="w-full">
        {/* Responsive Grid for Tabs: Stacks neatly on mobile */}
            ...
            <CardContent className="p-4 sm:p-6 pt-0 space-y-6">
              <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none">
                <p className="text-sm sm:text-base md:text-lg font-medium leading-relaxed break-words">
                  {test.detailedReport?.writing?.aiFeedback || "AI evaluation pending or not available for this session."}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-3 sm:space-y-4">
          {data.map((item: any, i: number) => (
            ...
            >
              ...
              {/* Icon absolutely positioned on mobile, static on desktop */}
